...
void bridgeRoad()
{
    ...
    glLineWidth(15.5);
    glBegin(GL_LINES); // bridge top part
    for (int i = 0; i < 200; i++)
    {
        glColor3ub(178, 34, 34);
    ...
    glPushMatrix(); //glPushMatrix — push and pop the current matrix stack
...
void update1(int value) //for water
{
    ...
    glutPostRedisplay();
    glutTimerFunc(200, update1, 0); //glutTimerFunc registers a timer callback to be triggered in a specified number of milliseconds.
}
